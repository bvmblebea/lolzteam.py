...
class Lolzteam:
	...
	def get_post_likes(self, post_id: int, page: int = None, limit: int = 10) -> dict:
	...
	def find_user(self, username: str = None, user_email: str = None) -> dict:
	...
	def create_profile_post(self, user_id: int, content: str) -> dict:
		data = {"post_body": content}
		return requests.post(
	...
	def edit_profile_post(self, profile_post_id: int, content: str) -> dict:
		data = {"post_body": content}
		return requests.put(
			f"{self.api}/profile-posts/{profile_post_id}",
			data=data,
	...
	def delete_profile_post(self, profile_post_id: int, reason: str = None) -> dict:
		url = f"{self.api}/profile-posts/{profile_post_id}"
		if reason:
			url += f"?reason={reason}"
		return requests.delete(url, headers=self.headers).json()

	def get_profile_post_likes(self) -> dict:
		return requests.get(
	...
	def get_profile_post_comments(self, before: str = None, limit: int = 10) -> dict:
		url = f"{self.api}/profile-posts/{profile_post_id}/comments?limit={limit}"
		if before:
			url += f"&before={before}"
		return requests.get(url, headers=self.headers).json()

	def comment_profile_post(self, comment: str) -> dict:
		data = {"comment_body": comment}
		return requests.post(
			f"{self.api}/profile-posts/{profile_post_id}/comments",
			headers=self.headers).json()

	def get_profile_post_comment(self, profile_post_id: int, comment_id: int) -> dict:
		return requests.get(
	...
	def report_profile_post(self, profile_post_id: int, message: str) -> dict:
		data = {"message": message}
		return requests.post(
	...
	def get_conversations(self, page: int = None, limit: int = 10) -> dict:
	...
	def edit_message(self, message_id: int, content: str) -> dict:
